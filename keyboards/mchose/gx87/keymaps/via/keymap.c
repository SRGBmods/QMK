...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_ansi( /* FN */
		...
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, UG_HUEU, UG_NEXT, _______, _______, _______, _______,
		...
		_______, GU_TOGG, _______,                            _______,                            _______, _______, _______, _______, UG_SPDD, UG_VALD, UG_SPDU),
    ...
    [3] = LAYOUT_ansi( /* FN */
		...
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                   _______,          UG_VALU,
		_______, _______, _______,                            _______,                            _______, _______, _______, _______, UG_SPDD, UG_VALD, UG_SPDU),
};
