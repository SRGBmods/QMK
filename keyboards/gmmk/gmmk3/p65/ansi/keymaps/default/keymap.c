...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FL] = LAYOUT(
        ...
        _______,            UG_SATD,  UG_SATU,  UG_SPDD,  UG_SPDU,  KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_MPRV,  KC_MPLY,  KC_MNXT,  _______,  UG_VALU,  KC_HOME,
        _______,  GU_TOGG,  _______,                                _______,                      _______,  _______,            UG_PREV, UG_VALD,  UG_NEXT
    ),
    ...
    [MACOS_FL] = LAYOUT(
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_PSCR,  KC_SCRL,  KC_PAUS,  KC_INS,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,  KC_PGDN,
        _______,            UG_VALD,  UG_SATU,  UG_SPDD,  UG_SPDU,  KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_MPRV,  KC_MPLY,  KC_MNXT,  _______,  UG_VALU,  KC_HOME,
        _______,  _______,  _______,                                _______,                      _______,  _______,            UG_PREV, UG_VALD,  UG_NEXT
    ),
};
