...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FL] = LAYOUT(
        ...
        _______,  _______,  UG_SATD,  UG_SATU,  UG_SPDD,  UG_SPDU,  KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_MPRV,  KC_MPLY,  KC_MNXT,  _______,  UG_VALU,  KC_HOME,
        _______,  GU_TOGG,  _______,                                _______,                      _______,  _______,            UG_NEXT,  UG_VALD,  UG_NEXT
    ),
