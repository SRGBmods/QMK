...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FL] = LAYOUT(
        ...
        _______,  _______,  UG_SATD,  UG_SATU,  UG_SPDD,  UG_SPDU,  _______,  _______,  _______,  _______,  _______,  _______,            _______,               UG_VALU,               _______,  _______,  _______,  _______,
        _______,  GU_TOGG,  _______,                                _______,                                _______,  _______,  _______,  _______,     UG_PREV,  UG_VALD,  UG_NEXT,     _______,            _______
    ),
